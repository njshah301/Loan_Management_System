...
public class ItemController {
	...
	{ 
		logger.info("ItemController: Entered inside getItemsById() method");
		List<ItemDto> itemDto=itemService.getItemsByCategory(category);
		return itemDto;
	}
	
	@GetMapping(path="/description/{description}")
	public ItemDto getItemsByDescription(@PathVariable String description)
	{ 
		logger.info("ItemController: Entered inside getItemsById() method");
		ItemDto itemDto=itemService.getItemsByDescription(description);
		return itemDto;
	}
